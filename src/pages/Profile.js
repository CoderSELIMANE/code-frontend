...
const Profile = () => {
  ...
  // S'assurer que les champs de mot de passe sont vides quand la section s'ouvre
  useEffect(() => {
    if (showPasswordSection) {
      ...
      // Réinitialisation avec délai pour contrer l'auto-complétion
                  ...
                  <div className="mb-4">
                    <div className="d-flex align-items-center justify-content-between mb-3">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          // Réinitialiser les champs de mot de passe quand on ouvre/ferme la section
                          setFormData(prev => ({
                            ...prev,
                            current_password: '',
                            new_password: '',
                    ...
                    {showPasswordSection && (
                      <div className="border rounded p-3 bg-light">
                        {/* Champs factices pour tromper l'auto-complétion */}
                        ...
                        <div className="mb-3">
                          ...
                          <input
                            ...
                            autoFocus={false}
                            key={`current_password_${showPasswordSection}_${Date.now()}`}
                            data-lpignore="true"
